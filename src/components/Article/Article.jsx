...
const Article = () => {
    const [newsList , setNewsList] = useState([
        ...
        { pic:'./news3.jpg' , desc:"هوش مصنوعی یکی از حوزه‌های پیشرفته و جذاب علوم کامپیوتر است که در دهه‌های اخیر بسیار مورد توجه قرار گرفته است.در این بخش، مقاله کوتاه در مورد هوش مصنوعی خواهیم داشت." },
    ])
