...
const [lastCyrcle, setLastCyrcle] = useState([
  ...
  return (
    <ul className='flex justify-items-center pt-8 lg:pb-6 mx-auto mt-12 gap-2 max-[550px]:flex-col max-[550px]:items-center max-[550px]:pt-0 max-[550px]:mt-8 max-[400px]:gap-1 max-[400px]:mt-12' style={{direction : 'ltr'}}>
        <li className={`max-[350px]:p-[14px] max-[350px]:h-0 max-[350px]:w-0 h-8 w-8 p-4 flex items-center justify-center rounded-full bg-gray-300 text-black font-semibold ${firstCyrcle[step]}`}>
            1
        </li>
        ...
        <li className={`max-[350px]:p-[14px] max-[350px]:h-0 max-[350px]:w-0 h-8 w-8 p-4 flex  items-center justify-center rounded-full bg-gray-300 text-black font-semibold ${secondCyrcle[step]}`}>
            2
        </li>
        ...
        <li className={`max-[350px]:p-[14px] max-[350px]:h-0 max-[350px]:w-0 h-8 w-8 p-4 flex  items-center justify-center rounded-full bg-gray-300 text-black font-semibold ${thirdCyrcle[step]}`}>
            3
        </li>
        ...
        <li className={`max-[350px]:p-[14px] max-[350px]:h-0 max-[350px]:w-0 h-8 w-8 p-4 flex  items-center justify-center rounded-full bg-gray-300 text-black font-semibold ${lastCyrcle[step]}`}>
            4
        </li>        
    </ul>
  )
